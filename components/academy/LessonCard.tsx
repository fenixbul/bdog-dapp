...
export function LessonCard({ lesson, onClick }: LessonCardProps) {
  return (
    <button
      onClick={onClick}
      className="w-full bg-[#00ff9e] text-black dark:bg-zinc-900 dark:text-white p-4 rounded-2xl shadow-sm border border-primary dark:border-zinc-800 flex items-center gap-4 group relative overflow-hidden hover:shadow-md transition-transform duration-200 ease-out hover:scale-[1.01] active:scale-[0.99]"
    >
      {/* Icon Wrapper */}
