 ...
 *
 * Renders on Profile, Rewards, and Wallet pages
 * Higher z-index (z-50) to render above main BottomTab
 */
...
interface AccountBottomTabProps {
  className?: string;
  activePath?: string;
}

export function AccountBottomTab({
  className = "",
  activePath,
}: AccountBottomTabProps) {
