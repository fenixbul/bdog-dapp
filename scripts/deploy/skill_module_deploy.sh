...
# Purpose: Deploy skill module canisters to local DFX replica
# Usage: ./scripts/deploy/skill_module_deploy.sh

set -e  # Exit on any error

echo "🚀 Deploying Skill Module Canisters..."
...
# Can be extended in the future to add more skill-related canisters
CANISTERS=(
    "skill_module"
)
...
print_status "All skill module canisters deployed successfully"
